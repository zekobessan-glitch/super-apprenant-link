...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "La plateforme qui connecte les parents à des encadreurs qualifiés selon le profil d'apprentissage de chaque enfant." },
      { property: "og:description", content: "La plateforme qui connecte les parents à des encadreurs qualifiés selon le profil d'apprentissage de chaque enfant." },
      { name: "twitter:description", content: "La plateforme qui connecte les parents à des encadreurs qualifiés selon le profil d'apprentissage de chaque enfant." },
